...
<template>
	...
	<div class="d-md-flex" id="techHeader">
		<div class="col-md-6 col-12 flex-md-equal p-3 p-md-5 m-md-3 
			bg-dark text-white rounded">
			This is the text
		</div>
		<div class="col-md-6 col-12 col-xs-12 flex-md-equal p-3 p-md-5 m-md-3
