...
function onScroll() {
  ...
  for (const circle of circles) {
    if (
      circle != null &&
      !circle.classList.contains("floatBalls") &&
      scrollPos > 0
    ) {
...
<template>
  <div
    id="homeHeader"
    class="position-relative overflow-hidden overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light"
    style="z-index: -2"
  >
    <div class="">
      <h1>asdfsad Welcome</h1>
      This is a personal site for personal reasons, mostly to serve as a
      playground for learning new web technologies
    </div>
